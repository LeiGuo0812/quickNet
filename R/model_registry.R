...
quicknet_model_registry_rows <- function() {
  list(
    ...
    quicknet_model_registry_row("mlVAR", "intensive_longitudinal", "LongitudinalNet", "mlVAR::mlVAR", "exploratory", TRUE, "default, temporal, contemporaneous, between", "temporal/contemporaneous/between networks; network summary", "Bringmann et al. 2013", "Estimation can be slow and sensitive to random-effects structure."),
    ...
    quicknet_model_registry_row("mixedVAR", "time_series", "MixedVARNet", "mgm::mvar", "exploratory", TRUE, "default, temporal", "temporal mixed VAR network; network summary", "Haslbeck and Waldorp 2020", "Rows must be correctly time ordered."),
    quicknet_model_registry_row("time_varying_mvar", "time_series", "TimeVaryingNet", "mgm::tvmvar", "exploratory", TRUE, "estpoint_*", "time-varying mixed VAR networks; network summary", "Haslbeck and Waldorp 2020", "Bandwidth and estimation points strongly affect results."),
